 ...
 *//**
	...
	*//*
		 ...
		 * 
		 * public String username; public String password; public String role;
		 * 
		 * public CustomUser(User byEmail) { this.username = byEmail.getEmail();
		 * 
		 * this.password = byEmail.getPassword(); this.role = byEmail.getRole(); }
		 * 
		 * @Override public Collection<? extends GrantedAuthority> getAuthorities() { //
		 * 
		 * List<GrantedAuthority> list = new ArrayList<>();
		 * 
		 * list.add(new SimpleGrantedAuthority(role)); return list; }
		 * 
